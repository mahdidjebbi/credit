...
) 
{
    ...
    $formationF->updateFormation($_POST["idFormation"],$_POST["nom"],$_POST["description"]);
        header('Location:listeFormation.php');//==> transistion de page
...
<div class="sidebar pe-4 pb-3">
    ...
    <hr>
  <button><a href="ListFormation.php">Back to list</a></button>
    <div id="error">
        <?php echo $error; ?>
    </div>
 <?php
    if (isset($_POST['idFormation'])) {
        $formation = $formationF->showFormationt($_POST['idFormation']);
    ...
    ?>
        <form action="" method="POST">
            <table border="1" align="center">
                ...
                <input type="hidden" name="idFormation" id="idFormation" value="<?php echo $formation['idFormation']; ?>">
  ...
  <tr>
                    ...
                    <td><input type="text" name="nom" id="nom" value="<?php echo $formation['nom']; ?>" maxlength="20"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="description" id="description" value="<?php echo $formation['description']; ?>" maxlength="20"></td>
                </tr>
